...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Plezi - the easy way to add Websockets services and RESTful routing to your Ruby application.'
  spec.description   = 'Plezi - the easy way to add Websockets services and RESTful routing to your Ruby application.'
