		...
		module ControllerCore
			...
			module ClassMethods
				...
				def has_exposed_method? method_name
					@exposed_methods_list ||= ( (self.superclass.public_instance_methods - Class.new.public_instance_methods - Plezi::ControllerMagic::InstanceMethods.instance_methods - [:before, :after, :save, :show, :update, :delete, :initialize, :on_message, :pre_connect, :on_open, :on_close]).delete_if {|m| m.to_s[0] == '_'} ).to_set
